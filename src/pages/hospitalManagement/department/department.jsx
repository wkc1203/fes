...
class FunctionalDepartment extends React.Component {
      ...
      action = (ids, hisId, operType) => {
        ...
        if (operType == 'del') {
            confirm({
                ...
                onOk() {
                    dispatch({ type: 'department/action', payload: { ids, hisId,operType } });
                },
            });
        } else {
            dispatch({ type: 'department/action', payload: { ids, hisId, operType } });
    ...
    render() {
        console.log(this.props.data,this.props.data && this.props.data.recordList.length)
        ...
        return (
            <div>
                ...
                <Modal
                    ...
                    onCancel={this.handleCancel}
                >
                    <div className='hospitalName'><span>科室名称</span>
