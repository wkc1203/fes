...
export function action(param) {
  return utils.request('/api/mch/health/api/chronicDisease/audit/single', {
    method: 'POST',
    body: utils.jsonToQueryString({ ...param }),
  });
}

// export function actions(param) {
//   return utils.request('/api/mch/health/api/chronicDisease/audit/single', {
//     method: 'POST',
//     body: utils.jsonToQueryString({ ...param }),
//   });
...
export function ewm(param) {
  return utils.request('/api/mch/health/api/chronicDisease/sign/query', {
    method: 'POST',
    body: utils.jsonToQueryString({ ...param }),
  });
}
