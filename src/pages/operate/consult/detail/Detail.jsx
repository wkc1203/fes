...
class Widget extends React.Component {
  ...
  getDetail = () => {
    ...
    console.log(this.props.location.query.inquiryId)
    if(this.props.location.query.inquiryId){
      dispatch({
        type: 'operateConsultDtl/getDetailById',
        payload: { id:this.props.location.query.inquiryId, }
      });
    }else{
      dispatch({
        type: 'operateConsultDtl/getDetail',
...
export default connect((state) => {
  const { operateConsultDtl = {} } = state;
  return {
    modelData: operateConsultDtl,
  };
})(Widget);
