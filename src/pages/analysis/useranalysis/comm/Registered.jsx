...
class Widget extends React.Component {
  state = {
        startDate1: formatDate(new Date(new Date() - (6 * 24 * 60 * 60 * 1000))),
  ...
  activeNum1=()=>{
    ...
    dispatch({
      type: 'userAnalysis/getaccountnumstatistics' ,
      payload:{
  ...
  activeChart2=()=>{
    const { dispatch } = this.props;
    dispatch({
      type: 'userAnalysis/getaccountanalysisstatistics' ,
      payload:{
                // hisId: sessionStorage.getItem('hisId'),
                platformId:sessionStorage.getItem('hisId'),
  ...
  activeChart3=()=>{
    const { dispatch } = this.props;
    dispatch({
      type: 'userAnalysis/getnewusernumstatistics' ,
      payload:{
            platformId:sessionStorage.getItem('hisId'),
  ...
  getChart1 = () => {
    const { RegisterData1: data = [] } = this.props.modelData;
  ...
  getChart2 = () => {
    const { RegisterData2: data = [] } = this.props.modelData;
    // const { inquirytotal: data = [] } = modelData;
