...
class deptanalysisdetail extends React.Component {
    state={
        detailData:[],
        detailData1:[],
        detailData2:[],
    ...
    getdata=(type,type1='',dayNum='all',startDate='',endDate='')=>{
        ...
        let payload={}
        if(type==1){
            payload={no:location.query.no,hisId: sessionStorage.getItem('hisId'),}

        }else if(type==2){
            payload={
                hisId: sessionStorage.getItem('hisId'),
                no:location.query.no,
                type:type1,
                dayNum:dayNum,
        ...
        dispatch({
            type: 'deptanalysisdetil/getdeptanalysisstatisticsde',
            payload,
            callback:(data)=>{
    ...
    inquirytable=()=>{
        ...
        dispatch({
            type: 'deptanalysisdetil/getinquirytypestatistics',
            payload:{
                hisId: sessionStorage.getItem('hisId'),
                deptId:location.query.no,
    ...
    inquiryChart=()=>{
        const { dispatch, location} = this.props;
        dispatch({ 
            type: 'deptanalysisdetil/getinquirytotalstatistics' ,
            payload:{
                hisId: sessionStorage.getItem('hisId'),
    ...
    changeChartDate3=()=>{
        // console.log(this.state.granularity3)
        this.setState({
            dayNum3:''
        },()=>{
            this.inquiryChart()
...
export default connect((state) => {
    const { deptanalysisdetil = {} } = state;
    return {
      modelData: deptanalysisdetil,
    };
  })(deptanalysisdetail);