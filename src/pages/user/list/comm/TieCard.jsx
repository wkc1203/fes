...
class Widget extends React.Component {
  ...
  render() {
    const totalCount = this.props.TieCardList ? this.props.TieCardList.totalCount : 0;
    const currentPage = this.props.TieCardList ? this.props.TieCardList.currentPage : 0;
    const columns = [
      {
        title: '姓名',
        dataIndex: 'realName',
    ...
    const data = this.props.TieCardList && this.props.TieCardList.recordList.length > 0 ?
    this.props.TieCardList.recordList.map((item, key) => {
      return {
        key: key + 1,
